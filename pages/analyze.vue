...
import AnalyzeApplyStuData from '~/components/analyze/applyStuData.vue'
...
const anaList = [
  ...
  { feat: '申請入學', value: 3, comp: AnalyzeApplyStuData, icon: 'circle' },
  { feat: '繁星推薦', value: 4, comp: AnalyzeStarStuData, icon: 'circle' },
  // { feat: '排名分佈', value: 2 },
  // { feat: '趨勢分析', value: 3 },
  // { feat: '大專院校排名', value: 4 },
  // { feat: '地區組成', value: 5 },
